...
class TestCollindMethods(unittest.TestCase):
    ...
    def test_excel_func(self):
        ...
        self.assertEqual(excelfunc.CreateGameID(3), 58, "check if number is updated to the next one, need to update the last argument number!!")
    ...
    def test_action_list (self):
        ...
        self.assertEqual(excelfunc.gamesOfUser("tester"),[41,42,44,52,53,54,55,56,57],"Exctart was wrong check SQL ALSO")


    def cardandcubefunc(self):
        self.assertTrue(cardandcube.cardenablef(3),"Card is Disable")
        self.assertTrue(cardandcube.cardenablef(8), "Card is Enable")
